...
class BuckwalterTable extends EncodingTableBase {
	...
	private BuckwalterTable() {
		...
		addItem(UnicodeType.SmallHighYa, '/', CharacterType.SmallHighYa); //[Haroon Lone] Addition of SmallHighYa
		addItem(UnicodeType.SmallHighNoon, '!', CharacterType.SmallHighNoon);
		addItem(UnicodeType.Sajda, 'J', CharacterType.Sajda); //[Haroon Lone]
		...
		addItem(UnicodeType.PausePermissibleContinue, 'P', CharacterType.PausePermissibleContinue);
		addItem(UnicodeType.PausePermissiblePreferred, 'Q', CharacterType.PausePermissiblePreferred);
		addItem(UnicodeType.PauseCompulsory, 'M', CharacterType.PauseCompulsory);
		addItem(UnicodeType.PauseImpermissible, 'L', CharacterType.PauseImpermissible);
		addItem(UnicodeType.PausePermissible, 'C', CharacterType.PausePermissible);
		addItem(UnicodeType.PauseInterchangeable, 'O', CharacterType.PauseInterchangeable);
		addItem(UnicodeType.VerseEnd, 'U', CharacterType.VerseEnd);
		addItem(UnicodeType.HizbRub, 'V', CharacterType.HizbRub);
		
		
		addItem(UnicodeType.AlifBelow, ')', CharacterType.AlifBelow);
		addItem(UnicodeType.DotBelow, '?', CharacterType.DotBelow);
		addItem(UnicodeType.SukunKha, 'c', CharacterType.SukunKha);
		addItem(UnicodeType.MaddahHigh, '\\', CharacterType.MaddahHigh);
		addItem(UnicodeType.RaDot, 'R', CharacterType.RaDot);
		addItem(UnicodeType.HaEnd, 'e', CharacterType.HaEnd);
		addItem(UnicodeType.RingBelow, '(', CharacterType.RingBelow);
	}
}
