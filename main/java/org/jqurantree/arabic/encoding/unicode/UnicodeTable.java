...
class UnicodeTable extends EncodingTableBase {
	...
	private UnicodeTable() {
		...
		addItem(UnicodeType.AlifKhanjareeya, (char) 1648, CharacterType.Alif,DiacriticType.AlifKhanjareeya);
		...
		addItem(UnicodeType.SmallHighYa, (char) 1767, CharacterType.SmallHighYa); //[Haroon Lone]
		addItem(UnicodeType.SmallHighNoon, (char) 1768,
				CharacterType.SmallHighNoon);
		addItem(UnicodeType.Sajda, (char) 1769, CharacterType.Sajda); //[Haroon Lone]
		...
		//[Haroon Lone] Appending starts
		addItem(UnicodeType.PausePermissibleContinue, (char) 1750, CharacterType.PausePermissibleContinue); //[Haroon Lone]
		addItem(UnicodeType.PausePermissiblePreferred, (char) 1751, CharacterType.PausePermissiblePreferred); //[Haroon Lone]
		addItem(UnicodeType.PauseCompulsory, (char) 1752, CharacterType.PauseCompulsory); //[Haroon Lone]
		addItem(UnicodeType.PauseImpermissible, (char) 1753, CharacterType.PauseImpermissible); //[Haroon Lone]
		addItem(UnicodeType.PausePermissible, (char) 1754, CharacterType.PausePermissible); //[Haroon Lone]
		addItem(UnicodeType.PauseInterchangeable, (char) 1755, CharacterType.PauseInterchangeable); //[Haroon Lone]
		addItem(UnicodeType.VerseEnd, (char) 1757, CharacterType.VerseEnd); //[Haroon Lone]
		addItem(UnicodeType.HizbRub, (char) 1758, CharacterType.HizbRub); //[Haroon Lone]
		
		addItem(UnicodeType.AlifBelow, (char) 1622, CharacterType.AlifBelow);
		addItem(UnicodeType.DotBelow, (char) 1628, CharacterType.DotBelow);
		addItem(UnicodeType.SukunKha, (char) 1761, CharacterType.SukunKha);
		addItem(UnicodeType.MaddahHigh, (char) 1764, CharacterType.MaddahHigh);
		addItem(UnicodeType.RaDot, (char) 1684, CharacterType.RaDot);
		addItem(UnicodeType.HaEnd, (char) 1749, CharacterType.HaEnd);		
		addItem(UnicodeType.RingBelow, (char) 805, CharacterType.RingBelow);
